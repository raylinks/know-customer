...
exports.Migrations1716626735357 = void 0;
class Migrations1716626735357 {
    constructor() {
        this.name = 'Migrations1716626735357';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "kyc_level" ADD CONSTRAINT "FK_2a26e10e302543056391a857ce4" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_8aa9d04293c215ebd8e01e6760b" FOREIGN KEY ("imageDataId") REFERENCES "kyc_documents"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_7306f0c1d787ce538ac49198e68" FOREIGN KEY ("apiServiceId") REFERENCES "api_keys"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_cfa83f61e4d27a87fcae1e025ab" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
exports.Migrations1716626735357 = Migrations1716626735357;
//# sourceMappingURL=1716626735357-casha-migrations.js.map